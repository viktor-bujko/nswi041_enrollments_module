...
[*Express the information model of the domain as a UML class diagram. Do not use class methods in the diagram, only classes, class attributes and associations connecting classes.*]
